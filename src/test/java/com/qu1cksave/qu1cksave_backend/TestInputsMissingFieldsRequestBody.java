...
public class TestInputsMissingFieldsRequestBody {
    public static String testNewJobMissingTitle = """
			{
    ...
    public static String testNewJobNullTitle = """
			{
				"title": null,
				"company_name": "test company",
				"job_description": "test job description",
	...
	public static String testNewJobDateAppliedMissingYear = """
			{
				"title": "test swe",
				"company_name": "test company",
				"job_description": "test job description",
	...
	public static String testNewJobResumeMissingFileName = """
			{
				"title": "test swe",
				"company_name": "test company",
				"job_description": "test job description",
