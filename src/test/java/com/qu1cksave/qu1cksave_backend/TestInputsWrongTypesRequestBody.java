...
public class TestInputsWrongTypesRequestBody {
    // title
    public static String testNewJobIntegerTitle = """
			{
				"title": 5,
    ...
    // salary_min
    public static String testNewJobStringSalaryMin = """
			{
				"title": "test swe",
				"company_name": "test company",
				"job_description": "test job description",
    ...
    // Date applied year
    public static String testNewJobDateAppliedBooleanYear = """
			{
				"title": "test swe",
				"company_name": "test company",
				"job_description": "test job description",
    ...
    public static String testNewJobLinksStringElement = """
			{
				"title": "test swe",
				"company_name": "test company",
				"job_description": "test job description",
    ...
    // Resume
    public static String testNewJobBooleanResume = """
			{
				"title": "test swe",
				"company_name": "test company",
				"job_description": "test job description",
    ...
    public static String testNewJobResumeByteArrayHasStrings = """
			{
				"title": "test swe",
				"company_name": "test company",
				"job_description": "test job description",
    ...
    public static String testNewJobCoverLetterStringByteArray = """
			{
				"title": "test swe",
				"company_name": "test company",
				"job_description": "test job description",
