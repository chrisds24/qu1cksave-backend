...
CREATE TABLE member(id UUID UNIQUE PRIMARY KEY DEFAULT gen_random_uuid(), email VARCHAR(254) UNIQUE, firebase_uid VARCHAR(128) UNIQUE, roles jsonb, name VARCHAR(255));
