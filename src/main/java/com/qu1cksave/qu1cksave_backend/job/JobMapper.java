...
public class JobMapper {
    ...
    // TODO: (5/2/2025)
    //   When creating a job, how do I deal with autogenerated columns?
...
//            YearMonthDateDto.toMap(dto.getDatePosted()),
        job.setDateApplied(YearMonthDateMapper.toEmbeddable(dto.getDateApplied()));
        job.setDatePosted(YearMonthDateMapper.toEmbeddable(dto.getDatePosted()));
